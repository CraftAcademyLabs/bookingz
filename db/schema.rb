...
ActiveRecord::Schema.define(version: 20160915093015) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean  "signed_up_but_not_approved", default: true
    t.index ["approved"], name: "index_users_on_approved", using: :btree
    t.index ["email"], name: "index_users_on_email", unique: true, using: :btree
    t.index ["not_approved"], name: "index_users_on_not_approved", using: :btree
    t.index ["reset_password_token"], name: "index_users_on_reset_password_token", unique: true, using: :btree
    t.index ["signed_up_but_not_approved"], name: "index_users_on_signed_up_but_not_approved", using: :btree
  end
