increment ||= Settings.slot_configuration.increment.to_i
...
json.id @resource.id
json.slots do
  slots = create_hour_range(increment: increment.minutes, start_time: start_time.hours, end_time: end_time.hours)
